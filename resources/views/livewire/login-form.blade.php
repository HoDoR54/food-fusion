@php
    use App\Enums\But        <div class="flex flex-col gap-2">
    ...
    <div class="w-full flex flex-col items-center justify-center gap-4 mt-4">
        ...
        />
        <span class="text-sm text-text/60">Don't have an account? <a href="{{ route('auth.register.show') }}" class="text-primary hover:text-secondary underline text-sm">Sign up here</a></span>
    </div> App\Enums\ButtonSize;
@endphp
    ...
    <div class="flex flex-col items-center justify-center">
        ...
        <p class="text-text/60 text-sm my-3">Sign in to your FoodFusion account</p>
    </div>
