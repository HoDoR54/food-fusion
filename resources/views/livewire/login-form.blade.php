...
>
    ...
    <div class="flex flex-col gap-3 w-full">
        <div class="flex flex-col gap-2">
            ...
            <input type="email" id="email" name="email" placeholder="johnDoe123@gmail.com" required class="bg-secondary/15 border border-gray-300 px-4 py-2 focus:outline-2 focus:outline-primary rounded w-full" />
        </div>
        <div class="flex flex-col gap-2">
            <label for="password" class="text-gray-600 text-sm">Password</label>
            <input type="password" id="password" name="password" placeholder="veryVerySecure123!@#" required class="bg-secondary/15 border border-gray-300 px-4 py-2 focus:outline-2 focus:outline-primary rounded w-full" />
        </div>
    ...
    <div class="w-full flex flex-col items-center justify-center gap-3">
        ...
        />
        <span class="text-sm text-gray-600">Don't have an account? <a href="{{ route('auth.register') }}" class="text-primary hover:text-secondary underline text-sm">Sign up here</a></span>
    </div>
