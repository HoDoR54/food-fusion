...
@section('content')
    <section class="w-full mb-4 min-h-[4rem] bg-secondary/30 rounded-2xl flex items-center justify-center text-text">
        Imaginary Search Bar
    </section>
    <section class="w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
        <div  class="bg-secondary/30 rounded-2xl text-text flex items-center justify-center p-3">
