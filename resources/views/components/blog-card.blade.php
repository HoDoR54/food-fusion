...
<a href="{{ route('blogs.show', ['uuid' => $blog->id]) }}" class="block group bg-secondary/10 border-dashed rounded-2xl border-2 border-primary/20 overflow-hidden shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1 cursor-pointer">
